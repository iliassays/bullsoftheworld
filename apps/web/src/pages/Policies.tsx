...
function PolicyPage({ kind }: { kind: "privacy" | "terms" }) {
  ...
  const privacySections = bn
    ? [
        ...
        ["ব্যবহারের তথ্য", `পৃষ্ঠা, ফিচার ইভেন্ট, ভাষা, প্রচারণার উৎস ও ছদ্মনামযুক্ত সেশন শনাক্তকারী আমাদের সার্ভারে সংগ্রহ করা হয়। কাঁচা সেশন আইডি সার্ভারে গোপন কী দিয়ে হ্যাশ করা হয়। ${researchBeta ? "গবেষণা বেটা" : "এই সেবা"} ব্যবহারের প্রবণতা বুঝতে Google Analytics ব্যবহার করে। EU/EEA ও UK থেকে আসা দর্শকদের জন্য এটি ডিফল্টভাবে বন্ধ থাকে যতক্ষণ না তারা সম্মতি দেন; অন্য সব জায়গায় এটি স্বয়ংক্রিয়ভাবে চলে।`],
        ...
        ["সংরক্ষণ ও নিয়ন্ত্রণ", `কাঁচা পণ্য অ্যানালিটিক্স সর্বোচ্চ ১৮০ দিন এবং ${researchBeta ? "বেটা ফিডব্যাক" : "জমা দেওয়া মতামত"} সর্বোচ্চ ৩৬৫ দিন রাখা হয়। অ্যাকাউন্ট, যোগাযোগের তথ্য বা মুছে ফেলার অনুরোধের জন্য সহায়তা ইমেইলে লিখুন। কিছু নিরাপত্তা ও আইনগত রেকর্ড সীমিত সময় রাখা হতে পারে।`],
    ...
    : [
        ...
        ["Usage data", `Pages, feature events, locale, campaign attribution and a pseudonymous session identifier are collected on our service. Raw session identifiers are keyed-hashed before server storage. ${researchBeta ? "The research beta" : "The service"} uses Google Analytics to understand usage patterns. For visitors from the EEA and UK this stays off by default until they consent; everywhere else it runs automatically.`],
        ...
        ["Retention and control", `Raw product analytics are retained for at most 180 days and ${researchBeta ? "beta feedback" : "submitted feedback"} for at most 365 days. Contact support to request account access, correction or deletion. Some security and legal records may need to remain for a limited period.`],
