...
const STRINGS: Record<string, Entry> = {
  ...
  "marketPulse.subtitle": {
    ...
    bn: "আগে বাজারের অবস্থা: সূচক, বাজারের বিস্তার, টার্নওভার ও খাতের নেতৃত্ব।",
  },
  "marketPulse.turnover": { en: "Turnover", bn: "টার্নওভার" },
  "marketPulse.turnoverSoFar": { en: "Turnover so far", bn: "এখন পর্যন্ত টার্নওভার" },
  "marketPulse.estimatedTurnoverSoFar": {
    en: "Estimated turnover so far",
    bn: "এখন পর্যন্ত আনুমানিক টার্নওভার",
  },
  "marketPulse.estimate": { en: "estimate", bn: "আনুমানিক" },
  "marketPulse.vs20d": { en: "vs 20-day avg", bn: "২০ দিনের গড়ের তুলনায়" },
  "marketPulse.ofFullSessionAvg": {
    en: "of 20-day full-session avg",
    bn: "২০ দিনের পূর্ণ-সেশন গড়ের",
  },
  "marketPulse.previousClose": { en: "previous close", bn: "আগের ক্লোজ" },
  "marketPulse.previousSession": { en: "previous session", bn: "আগের সেশন" },
  "marketPulse.breadth": { en: "Breadth", bn: "বাজারের বিস্তার" },
  "marketPulse.trackedBreadth": { en: "Tracked breadth", bn: "ট্র্যাক করা শেয়ারের বিস্তার" },
  "marketPulse.tracked": { en: "Tracked", bn: "ট্র্যাক করা" },
  "marketPulse.unchanged": { en: "flat", bn: "অপরিবর্তিত" },
  "marketPulse.coverageFull": {
    en: "Breadth represents nearly the full active product universe.",
    bn: "এই বাজারের বিস্তার প্রায় সব সক্রিয় শেয়ারকে প্রতিনিধিত্ব করে।",
  },
  ...
  "marketPulse.liveFooter": {
    en: "Breadth, turnover and sectors are current; the benchmark is the previous close.",
    bn: "বাজারের বিস্তার, টার্নওভার ও খাত আজকের; সূচকটি আগের ক্লোজের।",
  },
  "risk.risk_on": { en: "Risk-on", bn: "ঝুঁকি নেওয়ার পরিবেশ" },
  "risk.mixed": { en: "Mixed", bn: "মিশ্র" },
  "risk.defensive": { en: "Defensive", bn: "সতর্ক পরিবেশ" },
  ...
  "screen.newToList": { en: "New", bn: "নতুন" },
  "screen.newToListHelp": {
  ...
  "mc.reportedIncrease": { en: "Reported increase", bn: "রিপোর্টে বেড়েছে" },
  "mc.reportedDecrease": { en: "Reported decrease", bn: "রিপোর্টে কমেছে" },
  ...
  "cat.annual_report": { en: "Annual report", bn: "বার্ষিক প্রতিবেদন" },
  "cat.quarterly_report": { en: "Quarterly report", bn: "ত্রৈমাসিক প্রতিবেদন" },
  "cat.current_report": { en: "Current report", bn: "বর্তমান প্রতিবেদন" },
  "cat.foreign_report": { en: "Foreign issuer report", bn: "বিদেশি ইস্যুকারীর প্রতিবেদন" },
  "cat.acquisition": { en: "Acquisition", bn: "অধিগ্রহণ" },
  "cat.leadership": { en: "Leadership", bn: "নেতৃত্ব পরিবর্তন" },
  "cat.proxy": { en: "Proxy statement", bn: "প্রক্সি বিবৃতি" },
