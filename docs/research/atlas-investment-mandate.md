...
| `dse_bullish_ma20_50_v1` | EOD trend transition | Rejected as an entry strategy | The preregistered 20/50 bullish crossover produced only 24 holdout trades. Median net was -3.24%, the signal-date cohort trailed DSEX by 3.30 percentage points, and stressed cohort return was -1.57%. The positive raw mean depended on a small winner tail; excluding the two largest winners produced -1.50%. Keep the average relationship descriptive only. See `moving-average-crossover-result-2026-07-28.md`. |
...
| `us_bullish_ma20_50_v1` | EOD trend transition | Rejected | The preregistered 20/50 bullish crossover lost 0.37% on average in validation and 0.31% in holdout. Validation cohort excess was -1.44 percentage points with a fully negative 95% interval; holdout median was -3.19%, win rate 21.96%, and profit factor 0.93. It is a descriptive trend fact, not an Idea or Agent Decision. See `moving-average-crossover-result-2026-07-28.md`. |
